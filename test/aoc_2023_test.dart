...
void main() {
  test('textCalibrationValue', () {
    expect(textCalibrationValue('1abc2'), 12);
    expect(textCalibrationValue('pqr3stu8vwx'), 38);
...
7pqrstsixteen'''), 281);
  ...
  test('aoc-2023', () {
    final total = documentCalibrationValue('''jjfvnnlfivejj1
6fourfour
ninevbmltwo69
